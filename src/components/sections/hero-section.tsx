...
const TooltipIcon = ({
  ...
  <div className="group relative mt-4 px-1 sm:px-2">
    ...
    <div className="absolute -top-12 left-1/2 z-50 -translate-x-1/2 rounded-md bg-gray-900 px-3 py-1.5 text-sm text-white opacity-0 shadow-lg transition-opacity duration-300 group-hover:opacity-100 dark:bg-gray-100 dark:text-gray-900">
      {tooltipText}
      <span className="absolute -bottom-1 left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 bg-gray-900 dark:bg-gray-100"></span>
    </div>
  </div>
);
