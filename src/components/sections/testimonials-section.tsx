...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => {
  return (
    <div className="w-full px-4 md:w-1/2">
      <div className="relative mb-12 rounded-lg bg-card border border-border p-8 shadow-sm sm:p-10 lg:p-8 xl:p-10">
        ...
        <Image
          ...
          width={160}
          height={130}
          className="absolute bottom-0 right-0 -z-10 opacity-50"
        />
      </div>
    </div>
  );
...
const TestimonialsSection = () => {
  return (
    <section id="testimonial" className="relative z-10 bg-background pt-20 pb-30">
