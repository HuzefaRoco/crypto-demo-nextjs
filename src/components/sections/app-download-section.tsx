...
const AppDownloadSection: React.FC = () => {
  return (
    <section className="bg-white dark:bg-gray-900 pb-16 pt-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 max-w-[520px] lg:mb-0">
              ...
              <p className="mb-8 text-lg font-medium text-gray-600 dark:text-gray-300">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu, In et dignissim quam condimentum vel. Access your crypto portfolio anywhere with our mobile app.
              </p>
              <div className="flex flex-col gap-4 sm:flex-row">
                <a
                  href="#"
                  className="flex items-center justify-center rounded-lg bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 px-6 py-3 text-white transition-colors duration-300"
                >
                  <div className="mr-3">
