...
const PlayStoreIcon = () => (
  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M20.5701 13.714L17.7129 11.7583L4.85576 2.05688C4.41148 1.78545 3.86862 1.95688 3.81148 2.47116L3.85576 21.5712C3.85576 22.0426 4.3272 22.3712 4.77005 22.1426L20.5701 13.714Z"
      fill="currentColor"
    />
...
const AppDownloadSection = () => {
  return (
    <section className="bg-background pt-20 pb-[120px]">
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className="mb-3 block text-lg font-bold uppercase text-primary">
                Download Our App
              </span>
              <h2 className="mb-6 text-3xl font-bold leading-tight text-foreground md:text-[45px]">
                The choice is yours, we've got you covered
              </h2>
              <p className="mb-9 text-base font-medium text-muted-foreground">
              ...
              <div className="-mx-3 flex flex-wrap items-center">
                <div className="w-full px-3 sm:w-1/2">
                  <a
                    href="#"
                    className="mb-3 flex w-full items-center justify-center rounded-lg bg-primary px-6 py-4 text-center text-base font-semibold text-primary-foreground transition duration-300 hover:bg-primary/90 sm:mb-0"
                  >
                    <span className="mr-3">
                      <AppStoreIcon />
                    </span>
                ...
                <div className="w-full px-3 sm:w-1/2">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center rounded-lg bg-primary px-6 py-4 text-center text-base font-semibold text-primary-foreground transition duration-300 hover:bg-primary/90"
                  >
                    <span className="mr-3">
                      <PlayStoreIcon />
                    </span>
